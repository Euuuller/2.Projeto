...
Chart.defaults.plugins.tooltip.titleFont = { family: "'DM Sans', sans-serif", weight: '600', size: 15 };
Chart.defaults.plugins.tooltip.bodyFont = { family: "'DM Sans', sans-serif", size: 14 };
